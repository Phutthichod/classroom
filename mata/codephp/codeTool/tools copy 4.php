                                            ...
                                            <form action="/action_page.php">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-sm-12" id="conPic">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="card  col-sm-4 m-sm-2 " style=";">
                                                                        <img src="<?php echo $row["FilesName"];?>"
                                                        ...
                                                        <div id="sm4" class="col-sm-4"></div> <div class="col-sm-8 mt-sm-2 " > <button id="btnup2"
...
$(document).ready(function() {
    ...
    $("#addtool").click(function() {
        type = "ยังไม่ได้เลือกชนิด"
        $("#testPic").hide();
        $("#exampleModalScrollableTitle").text("เพิ่มอุปกรณ์");
        // $("#btnPic").text("เพิ่มรูปภาพ");
        $("#btnType").text("เลือกชนิดอุปกรณ์");
        $("#nameType").text(type);
        $("#sm4").hide();
    ...
    $(".btnInfo").click(function() {
        ...
        //  $("#btnPic").text("แก้ไขรูปภาพ");
        $("#nameType").text(type);

        //$("#nameType").addClass("text-center");
        $("#testPic").show();
        $("#sm4").show();
        $("#btnType").html(
        ...
        /*  let text = "";
          for (i = 0; i < 5; i++) {
              text += "<img src='20369012_1395452623870789_5868744507722911780_o.jpg' alt='Trulli' width='25' height='25'>";
          }*/
        // $("#namePic").html(text)
        $("#exampleModalScrollable").modal();
    });
